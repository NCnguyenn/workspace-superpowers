...
Progress updates and clarification questions may follow the user's conversational language. The actual requested report, outline, plan, document, or other authored content remains English unless an explicit applicable override exists. A report pasted into chat is still a deliverable, not a conversational update.
...
| Vietnamese input criterion; asks for an outline without specifying language | English outline; criterion quotations may retain their original wording |
